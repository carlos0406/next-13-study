...
const Input:React.FC<InputProps> = ({id,label,erros,register,disabled,formatPrice,required,type})=>{
  return (
    <div className="w-full relative">
      ...
      {`peer w-full p-4 pt-6 font-light bg-white border-2 rounded-md outline-none transition  disabled:opacity-70
       ...
       ${formatPrice?"pl-9":"pl-4"} ${erros[id]?"border-red-500":"border-neutral-300"} 
       ${erros[id]?"focus:border-red-500":"focus:border-black"}
       `}
      />
